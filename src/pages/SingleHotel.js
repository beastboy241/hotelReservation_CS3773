...
const SingleHotel = () => {
  ...
  const handleClick = async () => {
    if (!selectedValue || !startDate || !endDate) {
      setMsg({
        msg: "Missing input please check and try again...",
        display: true,
      });
      ...
      setMsg({
        msg: "You've already made a reservation for this hotel; room: " + room,
        display: true,
      });
    } else {
      let reservation = {
      ...
      <div className="singleHotels">
        ...
        <div className="grid-2">
          <div className="hotelCol-1">
            ...
            <h5 style={{ textIndent: 40 }}>
              {hotel.queen_price
                ? "Queen: $" + hotel.queen_price.toFixed(2)
                : ""}
            </h5>
            <h5 style={{ textIndent: 40 }}>
        ...
        <div className="singleHotels">
          <div className="grid-3">
            ...
            <div className="hotelCol-2" id="reserv-btn">
              <button className="reserv-btn" onClick={handleClick}>
                {" "}
                Reserve{" "}
              </button>
            </div>
